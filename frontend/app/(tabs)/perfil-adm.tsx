    ...
    <View style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity style={styles.menuItem}>
          <Ionicons name="person-outline" size={22} color="#222" style={styles.menuIcon} />
          <Text style={styles.menuText}>Gerenciar perfil</Text>
          <Feather name="chevron-right" size={22} color="#1e1e1e" style={styles.menuArrow} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}>
          <Ionicons name="people-outline" size={20} color="#222" style={styles.menuIcon} />
          <Text style={styles.menuText}>Visualizar usuarios inscritos</Text>
          <Feather name="chevron-right" size={22} color="#1e1e1e" style={styles.menuArrow} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}>
          <Ionicons name="add-circle-outline" size={20} color="#222" style={styles.menuIcon} />
          <Text style={styles.menuText}>Cadastrar novos programas</Text>
          <Feather name="chevron-right" size={22} color="#1e1e1e" style={styles.menuArrow} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}>
          <Feather name="edit" size={20} color="#222" style={styles.menuIcon} />
          <Text style={styles.menuText}>Atualizar programas ja cadastrados</Text>
          <Feather name="chevron-right" size={22} color="#1e1e1e" style={styles.menuArrow} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}>
          <Feather name="settings" size={20} color="#222" style={styles.menuIcon} />
