      ...
      <View style={styles.content}>
        ...
        <View style={styles.list}>
          ...
          <Text style={styles.itemText}>
            O dólar canadense é mais barato que o americano, o que torna o custo de um intercâmbio mais acessível.
          </Text>

          <Text style={styles.itemTitle}>2- Duração</Text>
          <Text style={styles.itemText}>
            Interagir diariamente com falantes nativos de inglês irá melhorar significativamente sua fluência e confiança no uso do idioma.
          </Text>

          <Text style={styles.itemTitle}>3- Diversidade Cultural</Text>
          <Text style={styles.itemText}>
            Além de falar inglês com nativos, você desenvolve o idioma em contato com pessoas com diferentes sotaques, já que o Canadá tem comunidade multicultural.
          </Text>

          <Text style={styles.itemTitle}>4- Média de Preço</Text>
          <Text style={styles.itemText}>
            Além de ser constantemente classificado como um dos países mais seguros do mundo, como estudante internacional você se sentirá seguro e bem-vindo. O país tem um friendly environment para imigrantes.
          </Text>

          <Text style={styles.itemTitle}>5- Requisitos</Text>
          <Text style={styles.itemText}>
            Ter proficiência em inglês é altamente valorizado no mercado de trabalho global. No Canadá você encontra programas de idiomas com vocabulário específico para áreas de interesse, como Marketing, Jurídico, Saúde e outros.
          </Text>
        </View>
